        ...
        <div className="md:w-1/2 p-6 flex flex-col justify-between bg-white">
          <div>
            ...
            <div className="flex items-center gap-2 mt-2 text-xs">
              ...
              <span className="text-slate-500">{product.reviewCount} student ratings</span>
            </div>
            ...
            <div className="mt-3 flex items-center gap-2 text-xs text-emerald-600 font-semibold">
              ...
              <span>Available for delivery to {selectedCollege.code}</span>
            </div>
          </div>
          ...
          <div className="pt-5 border-t border-slate-100 mt-4 flex items-center gap-3">
            <button
              ...
              className="flex-1 py-3 px-4 bg-[#ff6a00] hover:bg-[#ea580c] text-white font-bold text-xs rounded-xl flex items-center justify-center gap-2 shadow-md shadow-[#ff6a00]/20 transition-all cursor-pointer"
            >
