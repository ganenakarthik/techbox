      ...
      >
        ...
        >
          ...
          >
            <button
              ...
              className="w-full py-2 px-2 bg-white/95 hover:bg-white text-slate-800 text-[11px] font-bold rounded-xl flex items-center justify-center gap-1 shadow-md border border-slate-200 transition-all cursor-pointer"
            >
        ...
        <div className="p-3 sm:p-4 flex-1 flex flex-col justify-between">
          <div>
            ...
            <div className="flex items-center gap-1 text-[10px] sm:text-[11px] text-emerald-600 font-semibold mt-1.5">
              <Check className="w-3 h-3 shrink-0" />
              <span className="truncate">Campus Fast Dispatch</span>
            </div>
          </div>

          <div className="mt-2.5 pt-2.5 sm:mt-3 sm:pt-3 border-t border-slate-100 flex items-center justify-between gap-1">
            <div className="flex flex-col min-w-0">
              ...
              <span className="text-[9px] sm:text-[10px] text-slate-400 font-medium truncate">Per unit</span>
            </div>
            ...
            {cartQty === 0 ? (
              <button
                ...
                className="px-2.5 sm:px-4 py-1 sm:py-1.5 rounded-lg bg-white hover:bg-emerald-50 text-emerald-700 border-2 border-emerald-500 hover:border-emerald-600 text-[11px] sm:text-xs font-black transition-all flex items-center gap-1 shadow-2xs hover:shadow-xs active:scale-95 cursor-pointer uppercase tracking-wider shrink-0"
              >
