...
export function CarouselControls({
  ...
  return (
    <div className="flex flex-col items-center gap-4 mt-6 select-none">
      ...
      <div className="flex items-center gap-3 px-4 py-2 rounded-full bg-[#141414]/80 backdrop-blur-xl border border-white/10 shadow-lg text-xs font-mono">
      ...
      <div className="flex items-center gap-3 sm:gap-4">
        ...
        <button
          ...
          className="w-10 h-10 rounded-2xl bg-[#151515]/80 hover:bg-[#1f1f1f] backdrop-blur-md border border-white/10 hover:border-[#ff6a00]/50 flex items-center justify-center text-neutral-300 hover:text-white transition-all active:scale-95 shadow-lg group"
        >
          <ChevronLeft className="w-5 h-5 group-hover:-translate-x-0.5 transition-transform" />
        </button>

        {/* 8 Interactive Indicator Dots */}
        <div className="flex items-center gap-2 px-3 py-2 rounded-2xl bg-[#121212]/80 backdrop-blur-md border border-white/10">
          {members.map((m, idx) => {
