  ...
  return (
    <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-10">
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 pb-6 border-b border-[#1f1f1f] mb-8">
        <div>
          <h1 className="text-2xl sm:text-3xl font-black text-white">Student Account</h1>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
        ...
        <div className="lg:col-span-4 space-y-2">
          <div className="p-5 rounded-3xl bg-[#111111] border border-[#262626] flex items-center gap-3 mb-4">
            ...
            <div className="min-w-0">
              <div className="font-bold text-white text-sm truncate">{user?.name || "Student User"}</div>
              <div className="text-xs text-neutral-400 truncate">{user?.email || "student@srm.edu"}</div>
              ...
              <Link
                ...
                className={`flex items-center justify-between p-3.5 rounded-2xl border text-xs font-semibold transition-colors ${
                  link.active
                    ...
                    : "bg-[#111111] border-[#222222] text-neutral-400 hover:text-white hover:border-[#333333]"
                }`}
              >
          ...
          <button
            onClick={logout}
            className="w-full flex items-center gap-3 p-3.5 rounded-2xl bg-[#141414] border border-[#222222] text-xs font-semibold text-neutral-400 hover:text-[#ef4444] transition-colors mt-4"
          >
        ...
        <div className="lg:col-span-8">
          <div className="p-8 rounded-3xl bg-[#111111] border border-[#262626] shadow-xl space-y-6">
            <div>
              <h2 className="text-base font-bold text-white">Default Campus Delivery Details</h2>
            ...
            <div className="space-y-4 text-xs">
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div>
                  <label className="text-neutral-300 block mb-1 font-semibold">Your Name:</label>
                  <input
                    type="text"
                    value={name}
                    onChange={(e) => setName(e.target.value)}
                    className="w-full bg-[#161616] border border-[#262626] rounded-xl px-3.5 py-2 text-white focus:outline-none focus:border-[#ff6a00]"
                  />
                </div>
                <div>
                  <label className="text-neutral-300 block mb-1 font-semibold">Phone Number:</label>
                  <input
                    type="tel"
                    value={phone}
              ...
              <div>
                <label className="text-neutral-300 block mb-1 font-semibold">University / Institute:</label>
                <div className="p-3 rounded-xl bg-[#161616] border border-[#262626] text-white flex items-center justify-between">
              ...
              <div>
                <label className="text-neutral-300 block mb-1 font-semibold">Hostel Block & Room / Lab:</label>
                <input
                  type="text"
                  value={hostel}
