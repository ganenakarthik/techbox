      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-12">
        ...
        <div className="lg:col-span-5 space-y-6">
          <div className="p-8 rounded-3xl bg-[#111111] border border-[#262626] space-y-6">
            <h2 className="text-lg font-bold text-white">Central Operations Hub</h2>
            ...
            <div className="space-y-4 text-xs">
              ...
              <div className="flex items-start gap-3">
                ...
                <div>
                  <div className="font-bold text-white">Direct Helpline & WhatsApp</div>
                  <div className="text-neutral-400 mt-0.5">+91 98450 12345 / +91 94440 67890</div>
                  <div className="text-[10px] text-neutral-500">Mon - Sat: 9:00 AM – 9:00 PM IST</div>
                </div>
              </div>
              ...
              <div className="flex items-start gap-3">
                ...
                <div>
                  <div className="font-bold text-white">Campus Runner Hours</div>
                  <div className="text-neutral-400 mt-0.5">
          ...
          <div className="p-6 rounded-3xl bg-gradient-to-br from-[#161616] to-[#111111] border border-[#ff6a00]/20 flex items-center gap-4">
            <ShieldCheck className="w-8 h-8 text-[#ff6a00] shrink-0" />
            <div className="text-xs">
              <div className="font-bold text-white">100% Tested Lab Silicon</div>
              <div className="text-neutral-400 text-[11px] mt-0.5">Every IC, sensor, and MCU undergoes functional power-on boot validation before dispatch.</div>
            </div>
          </div>
        </div>
        ...
        <div className="lg:col-span-7">
          <div className="p-8 sm:p-10 rounded-3xl bg-[#111111] border border-[#262626] shadow-2xl">
            {submitted ? (
              <div className="text-center py-12 space-y-4">
                ...
                <button
                  ...
                  className="mt-6 py-2.5 px-6 rounded-xl bg-[#1f1f1f] text-neutral-300 hover:text-white text-xs font-semibold"
                >
              ...
              <form onSubmit={handleSubmit} className="space-y-5 text-xs">
                <div>
                  <h3 className="text-lg font-bold text-white">Submit a Direct Inquiry</h3>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  <div>
                    <label className="text-neutral-300 block mb-1.5 font-semibold">Your Name:</label>
                    <input
                      type="text"
                      required
                      value={name}
                  ...
                  <div>
                    <label className="text-neutral-300 block mb-1.5 font-semibold">Student / Work Email:</label>
                    <input
                      type="email"
                      required
                      value={email}
                ...
                <div>
                  <label className="text-neutral-300 block mb-1.5 font-semibold">Inquiry Category / Subject:</label>
                  <input
                    type="text"
                    required
                    value={subject}
                ...
                <div>
                  <label className="text-neutral-300 block mb-1.5 font-semibold">Detailed Message:</label>
                  <textarea
                    rows={5}
                    required
                    value={message}
                    ...
                    className="w-full bg-[#161616] border border-[#262626] rounded-xl p-3.5 text-white focus:outline-none focus:border-[#ff6a00] resize-none"
                  />
                </div>
