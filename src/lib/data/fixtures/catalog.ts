import { Product, ProjectKit, Category, Brand } from "../types";

/**
 * Development Catalog Fixtures
 * PARTSLY Frontend Test & Prototyping Dataset
 * (Isolated development fixtures — not connected to live database)
 */
...
export const BRANDS: Brand[] = [
  ...
  { id: "b4", name: "Partsly Lab Grade", slug: "partsly-lab" },
...
export const FIXTURE_PROJECT_KITS: ProjectKit[] = [
  {
    id: "kit-smart-agri",
...
export const PRODUCTS = FIXTURE_PRODUCTS;
export const PROJECT_KITS = FIXTURE_PROJECT_KITS;
